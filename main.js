...
module.exports = "<h1>{{title}}</h1>\n<select [(ngModel)]=\"url\">\n    <option *ngFor=\"let u of urlList\">{{u}}</option>\n</select>\n<button type=\"button\" (click)=\"getAll()\">Get tasks</button>"
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.getAll = function () {
        ...
        this.dataService.getTasks(this.url).subscribe(function (data) {
            console.log(data);
        }, function (error) {
            console.error(error);
        });
...
var DataService = /** @class */ (function () {
    ...
    DataService.prototype.getTasks = function (url) {
...
module.exports = __webpack_require__(/*! D:\AngularProjects\test-service\src\main.ts */"./src/main.ts");
